...
import static Clases.MyAdapter.Dialog;

/**
 * Created by Choche on 10/11/2017.
 */

public class OtroAdaptador extends RecyclerView.Adapter<OtroAdaptador.ViewHolder> {
    ...
    @Override
    public OtroAdaptador.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View v= LayoutInflater.from(parent.getContext()).inflate(R.layout.item_sugerencia, parent, false);

        OtroAdaptador.ViewHolder vh=new OtroAdaptador.ViewHolder(v);

        return vh;
    }

    @Override
    public void onBindViewHolder(OtroAdaptador.ViewHolder holder, int position) {
